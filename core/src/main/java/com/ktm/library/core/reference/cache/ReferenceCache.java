package com.ktm.library.core.reference.cache;

import com.github.benmanes.caffeine.cache.Caffeine;
import com.github.benmanes.caffeine.cache.LoadingCache;
import com.ktm.library.core.dictionary.Reference;
import com.ktm.library.core.exception.ReferenceValueNotFoundException;
...
public class ReferenceCache {
  ...
  public static ReferenceValue findByReferenceAndCode(
    ...
    try {
      return Objects.requireNonNull(cache.get(reference)).stream()
