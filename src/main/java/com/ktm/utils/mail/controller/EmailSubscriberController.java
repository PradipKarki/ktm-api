...
public class EmailSubscriberController {
	...
	public EmailSubscriber createEmailSubscriber(@Valid @RequestBody EmailSubscriber emailSubscriberDetails) {
		...
		Optional<EmailSubscriber> emailSubscriber = this.emailSubscriberRepository.findByEmailAddress(emailAddress);
	...
	// Update a EmailSubscriber, put on unsubscription list
	...
	public EmailSubscriber updateEmailSubscriberStatus(@Valid @RequestBody EmailSubscriber emailSubscriberDetails) {
		...
		EmailSubscriber emailSubscriber = this.emailSubscriberRepository.findByEmailAddress(emailAddress)
